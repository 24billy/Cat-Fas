...
public class Item {
	 ...
	 * @param delta
	 */
	public Item(Integer num, Integer dimension, Integer categoryNumber, Double delta) {
		super();
		this.num = num;
	 ...
	 * @param step2
	 */
	public Item(Integer num, Integer dimension, Integer categoryNumber, Double delta, Double step1, Double step2) {
		super();
		this.num = num;
		this.dimension = dimension;
		this.categoryNumber = categoryNumber;
